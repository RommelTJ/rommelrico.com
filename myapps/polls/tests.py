...
def create_poll(question, days):
    '''
    Creates a poll with the given question that is published the given number of days offset to 
...
class PollIndexDetailTests(TestCase):
    def test_detail_view_with_a_future_poll(self):
        """
        The detail view of a poll with a pub_date in the future should return a 404 error.
        """
